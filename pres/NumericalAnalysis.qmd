...
:::{.x_small_font}
$$f\left( x \right) = f\left( c \right) + \dot{f}\left( c \right)\left( x-c \right) + \frac{\ddot{f}\left( c \right)}{2!}\left( x-c \right)^2 + \frac{\dddot{f}\left( x-c \right)}{3!}\left( x-c \right)^3 + \dots + \frac{f^{\left(n\right)}\left( x-c \right)}{n!}\left( x-c \right)^n$$
:::
...
$$R_n\left( x \right) = \frac{f^{\left( n+1 \right)}\left( \zeta \right)}{\left( n+1 \right)!}\left( x-c \right)^{n+1}$$
