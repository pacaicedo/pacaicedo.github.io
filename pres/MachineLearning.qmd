...
```{python}
#| echo: false
path_to_data = "D:/DatasetsVault/spotify" # For Windows
#path_to_data = "/Users/pacaicedo/DatasetsVault/spotify" #For MacOsX
```
...
import numpy as np
archivoData = "D:/DatasetsVault/Salario/data_for_class.csv"
...
$$\mathbf{\theta}_{i,j+1} =  \mathbf{\theta}_{i,j} - \eta \frac{\partial E}{\partial \mathbf{\theta}_{i}}$$
