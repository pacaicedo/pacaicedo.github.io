...
::: {.callout-note title="Problema" collapsible="false"}
...
::: {.callout-warning title="Enfoque exacto:" collapsible="false"}
...
::: {.callout-warning title="Enfoque por Ajustes sucesivos:" collapsible="false"}
...
::: {.callout-note title="Interpolación polinomial" collapsible="false"}
...
## Polinomios de Lagrange{.scrollable}

::: {.callout-tip title="Algoritmo" collapsible="false"}

1. Determinar un polinomios $\gamma_i \left(x\right)$, que pase por $\left(x_i,1\right)$ y se anule para el resto de datos.
$$\gamma_i\left(x\right) = \prod_{j=0}^{n}\frac{x-x_j}{x_i-x_j}$$

Donde $i \neq j$

2. Determinar polinomio $P_i\left(x\right)$

$$P_i\left(x\right) = y_i \gamma_i\left(x\right)$$

3. Determinar polinomio $P\left(x\right)$
...
## Polinomio de Newton{.scrollable}


::: {.callout-note title="Nota" collapsible="false"}

1. Construir el polinomio $P_0 \left(x\right)$ el cuál pasa por el punto $\left(x_0, y_0\right)$. La propuesta más simple es $P_0 \left(x\right) = y_0$

2. Construir el polinomio $P_1 \left(x\right)$ el cuál pasa por el punto $\left(x_1, y_1\right)$, pero que parta de $P_0 \left(x\right)$. Una propuesta de este es $P_1 \left(x\right) = y_0+ c_1 \left(x-x_0\right)$

3. Construir el polinomio $P_2 \left(x\right)$ el cuál pasa por el punto $\left(x_2, y_2\right)$, pero que parta de $P_1 \left(x\right)$. Una propuesta de este es $P_2 \left(x\right) = y_0 + c_1 \left(x-x_0\right) + c_2\left(x-x_0\right)\left(x-x_1\right)$
:::

<!-- TODO: Interpolación con splines lineales y cúbicos, mínimos cuadrados  -->

# Integración y Diferenciación Numérica

<!-- TODO: Diferenciación numérica  4.2 de Arevalo Ovalle -->
