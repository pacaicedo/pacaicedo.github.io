...
format:
  revealjs: 
    ...
    css: styles.css
    footer: <https://pacaicedo.githhub.io>
resources:
  - demo.pdf
---
...
Coordinador de programa de Ingeniería de Software y Computación.
...
[https://discord.gg/KwjHvZaBbK](https://discord.gg/KwjHvZaBbK)

\normalsize

```{r figSvg,eval=TRUE,echo=FALSE,message=FALSE, error=FALSE, warning=FALSE,fig.height=5}
library(cowplot)
fig_svg<-cowplot::ggdraw()+cowplot::draw_image("./images/Discord Machine Learning.svg")
plot(fig_svg)
```
...
### Sala Zoom
ID de reunión: 811 5509 5461
Código de acceso: 661194

Requieren entrar con su cuenta de la UniAutonoma del Cauca.
